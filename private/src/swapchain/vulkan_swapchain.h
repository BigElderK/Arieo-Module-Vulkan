...
namespace Arieo
{
    ...
    public:
        ...
        std::uint32_t acquireNextImageIndex(Base::Interop::RawRef<Interface::RHI::ISemaphore> semaphore) override
        {
    ...
    private:
        ...
        std::vector<Base::Interop::RawRef<Interface::RHI::IImage>> m_image_resource_array;
