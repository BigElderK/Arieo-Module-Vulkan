...
namespace Arieo
{
    ...
    public:
        ...
        std::uint32_t acquireNextImageIndex(Base::InteropOld<Interface::RHI::ISemaphore> semaphore) override
        {
        ...
        std::vector<Base::InteropOld<Interface::RHI::IImageView>>& getImageViews() override
        {
    ...
    private:
        ...
        std::vector<Base::InteropOld<Interface::RHI::IImage>> m_image_resource_array;
        std::vector<Base::InteropOld<Interface::RHI::IImageView>> m_image_view_array;
    };
}